...
<div style="font-family:Verdana, Geneva, sans-serif; font-size:24px;width:900px;">Upload CSV Format file for Employee Data</div><br clear="all" /><br clear="all" />
<div align="left" class="vpb_main_wrapper"><br clear="all" />
<div id="vasPhoto_uploads_Status" align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black; lineheight:25px;"></div>
...
<div style="padding:10px; padding-top:18px;float:left;font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black; width:100px;" align="left">Browse File:</div>
