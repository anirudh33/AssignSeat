 ...
 * @Version                   -  1.0
 * Created by                  -  Keshi Chander Yadav
...
class validation {
     ...
     * @return Ambigous <string, multitype:string unknown Ambigous <string, string> >
     */
    function validate() {
    ...
    /**
     * Function is used to manage available file type that are valid
     *
     * @param string $ext
     * @return string
     */
    ...
    /**
     * Function is used to check size of file 
     *
     * @param array $postVar
     * @param string $value
     * @param string $error
    ...
    function validateFileSize($postVar, $value, $error) {
        ...
        if (is_array($postVar['name'])) {
            ...
            //if not an arry then start from else part
        } else {
    ...
    /**
     * Function is used to check availble phone type
     *
    ...
    function availablePhoneType($country) {
        ...
        //checking country name extension
        switch ($country) {
    ...
    /**
     * Function is used to Helps prevent XSS attacks
     *
     * @param string $string
     * @return string
     */
    ...
    /**
     * Function is used to prevent sql injection
     *
     * @param string $string
     * @return string
     */
